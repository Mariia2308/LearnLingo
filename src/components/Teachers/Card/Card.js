...
export const Card = ({ teacher, openModal, closeModal, isModalOpen }) => {
  ...
  return (
    <CardContainer>
      ...
      <div>
        <ContainerWithHeart>
          <StatsContainer>
            <ContainerWithSvg className="toHide">
              <svg width="16px" height="16px">
                <use href={`${icons}#icon-book`}></use>
              </svg>
              <Item>Lessons online</Item>
            </ContainerWithSvg>
            <Item className="toHide">Lessons done: {lessons_done}</Item>
            <ContainerWithSvg>
              <svg width="16px" height="16px">
          ...
          {reviews.map((review, index) => (
            <ReviewContainer key={index}>
              <ReviewerInfo>
                <div>
                  <ReviewerImg
                    src="/LearnLingo/project-pics/avatar.png"
                    alt="reviewer"
                  />
                </div>
                <div>
